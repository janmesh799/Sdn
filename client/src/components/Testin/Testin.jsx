...
const Testin = () => {
    ...
    const showOutput = async () => {
        ...
        if (method === 'POST') {
            const res = await axios.post(link, JSON.parse(data));
            const config = {
                headers: {
                    "Accept": "*/*"
                }
    ...
    return (
        <div>
            ...
            <div style={{ display: "flex", flexDirection: "row", justifyContent: "center", alignContent: "center", margin: " 10rem 20rem" }}>
                ...
                <input placeholder='data' style={{ width: "50%", alignSelf: "center", height: "10%" }} value={data} onChange={dataHandler} type="text" />
